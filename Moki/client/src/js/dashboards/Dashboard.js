...
const HAS_TABLE = ["calls", "conference", "diagnostics", "exceeded", "causeAnalysis", "network", "overview", "alerts", "qos", "realm", "registration", "restricted", "security", "system", "transport", "account"];
