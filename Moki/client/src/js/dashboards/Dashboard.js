...
const HAS_TABLE = ["calls", "conference", "diagnostics", "exceeded", "causeAnalysis", "flow", "network", "overview", "alerts", "qos", "realm", "registration", "restricted", "security", "system", "transport", "account"];
