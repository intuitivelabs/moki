...
import { getTimeBucketInt, getTimeBucket } from "../helpers/getTimeBucket";
...
const ABSOLUTE_VALUES = ["BLACKLISTED IPs", "WHITELISTED IPs", "LOAD-SHORTTERM", 
    "LOAD-MIDTERM", "LOAD-LONGTERM", "MEMORY-FREE", "MEMORY-USED", 
    "MEMORY-CACHED", "MEMORY-BUFFERED", "CPU-USER", "CPU-SYSTEM", "CPU-IDLE"];
const DONT_DISPLAY_OPTION = ["IPS ON FW BLACKLIST BY HOST", 
    "IPS ON FW GREYLIST BY HOST", "IPS ON FW WHITELIST BY HOST", "LOAD-SHORTTERM", 
    "LOAD-MIDTERM", "LOAD-LONGTERM", "MEMORY-FREE", "MEMORY-USED", 
    "MEMORY-CACHED", "MEMORY-BUFFERED", "CPU-USER", "CPU-SYSTEM", "CPU-IDLE"]
